...
//atributo que pertenece a la clase y ningun objeto.
    static contadorObjetosPersona = 0; //atributo de clase (solo clase)
    
    email = 'valor default'; //atributo de objeto: asigno valor para crerar. Se asocia al objeto y no la clase
